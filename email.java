...
public class email extends javax.swing.JFrame
{
    ...
    {    
        ...
        String str=s.substring(0,s.length()-4)+"encry."+sub;
        this.str=str;  
    }
    public email() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(240, 148, 0));

        jLabel2.setFont(new java.awt.Font("Andalus", 1, 18)); // NOI18N
        jLabel2.setText("ENTER EMAIL ID OF RECIEVER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SendAttachmentss sa=new SendAttachmentss(str3,str2);
